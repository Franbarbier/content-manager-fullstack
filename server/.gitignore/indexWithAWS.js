...
// CONFIGURATION OF S3
aws.config.update({
    secretAccessKey: "nuC9UzeZqKK3DoxKkkDLOwBLnP3pd2mF5RKgeues",
    accessKeyId: "AKIAYIG7UR3IOSWQAJIV",
    region: 'sa-east-1'
});
...
var upload = multer({
    ...
    storage: multerS3({
        ...
        bucket: 'content-creator-2/videos',
...
var uploadThumb = multer({
    ...
    storage: multerS3({
        s3: S3,
        // bucket - WE CAN PASS SUB FOLDER NAME ALSO LIKE 'bucket-name/sub-folder1'
        bucket: 'content-creator-2/thumbs',
        // META DATA FOR PUTTING FIELD NAME
        metadata: function (req, file, cb) {
